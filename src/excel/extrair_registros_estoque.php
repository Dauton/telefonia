...
<head>
    <meta charset="utf-8">
    <title>Excel Registros do estoque</title>
    
    <head>

    <body>
        <?php
        $nome_arquivo = 'REGISTROS_ATIVIDADES_ESTOQUE.xls';
        ...
        try {
            $result_tabela = $pdo->query("SELECT * FROM tb_logs_produtos ORDER BY id DESC");
