...
--
-- Table structure for table `tb_requisicoes`
--
...
--
-- Dumping data for table `tb_requisicoes`
--

LOCK TABLES `tb_requisicoes` WRITE;
/*!40000 ALTER TABLE `tb_requisicoes` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_requisicoes` ENABLE KEYS */;
UNLOCK TABLES;
