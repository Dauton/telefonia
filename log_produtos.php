...
$logs = new Logs($pdo);
$dados_logs = $logs->exibeRegistrosLogProdutos();
...
<body>
    <main class="corpo">
        ...
        <section class="principal">
            ...
            <article class="conteudo">
                ...
                <h3><a href="inicio.php">INÍCIO</a> / REGISTROS DO ESTOQUE</h3>
                    <div>
                ...
                <section class="conteudo-center">
                            <h1>Registro de atividades do estoque (30 dias)</h1>
                            <table>
                                <thead>
                                    <td>ID registro</td>
                                    <td>Usuário</td>
    ...
    <div class="btns-atalhos">
        <a href="src/excel/extrair_registros_estoque.php"><button id="btn-atalho" title="Extrair para Excel">
